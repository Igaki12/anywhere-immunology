        ...
        },
        {
            ...
            groupContents: [{
                ...
                },
                {
                    ...
                    answer: '1と6が誤り',
                    commentary: 'M細胞は抗原を直接樹状細胞に渡す。その他、上皮細胞がFcRnを介してオプソニン化された抗原を樹状細胞に渡したり、樹状細胞が樹状突起を伸ばして抗原を取り込んだりもする。腸管の樹状細胞により産生されるレチノイン酸はケモカインではないが、ケモカイン受容体CCR9やα4β7をリンパ球に発現させ、粘膜固有の内皮細胞が発現するCCL25とMadCAMと相互作用して粘膜固有層選択的ホーミングに寄与する。腸管では経口免疫寛容のためTregやTh17細胞が活動している。粘膜を使った免疫獲得・免疫寛容の誘導は粘膜ワクチンなどに利用されている。経口免疫寛容は制御性T細胞の役割であるため、Tregを別の人に注射すれば免疫寛容が誘導されるが、血清には含まれていない。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
            ...
            groupContents: [{
                ...
                },
                {
                    ...
                    answerImg: [],
                    answer: '',
                    commentary: 'リンパ球はビタミンCではなくケモカインによってホーミングされる。たとえばCCR7（T細胞）-CCL19/21（二次リンパ組織）の組み合わせ。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
