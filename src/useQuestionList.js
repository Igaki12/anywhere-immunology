      ...
      groupContents: [
        {
          ...
          questionImg: [],
          questionSentence:
            '免疫は大きく、自然免疫と獲得免疫（適応免疫）に分けられる。自然目根木ン関わる細胞には、組織中にとどまっている（ 1 ）、があり、主に食作用により微生物を処理する。獲得免疫を担う細胞免疫には、（ 2 ）や（ 3 ）があり、あわせて（ 4 ）という。(2)は主に、（ 5 ）から抗原提示を受けてインターロイキンなどの刺激物質を分泌することで（3）に働きかけ、抗体を分泌する（ 6 ）に分化させる。（2）にはウイルス感染細胞を直接攻撃し破壊するものもいる。獲得免疫のうち、抗体が関与する免疫を（ 7 ）免疫といい、（2）が直接標的細胞を殺すことを（ 8 ）免疫という。',
          answerImg: [],
          answer:
        ...
        },
        {
          ...
          choice: ['5/μL', '50/μL', '500/μL', '5000/μL', '50000/μL'],
          answerImg: [],
          answer: '5000/μL',
          commentary:
