        ...
        },
        {
            ...
            groupContents: [{
                ...
                },
                {
                    ...
                    answerImg: [TGFBeta],
                    answer: '3と6が誤り',
                    commentary: 'Th17細胞はIL-6やTGF-β、TregはTGF-βによって分化誘導される。TGF-βは主に活性化マクロファージやTregによって産生され、抑制性サイトカインと呼ばれる。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
                ...
                },
                {
                    ...
                    choices: ['肺炎球菌やインフルエンザ菌など、莢膜を持つ細菌の貪食にはオプソニンが重要である。', '結核診断には結核特異的な抗体の抗体価を測定するのが有効である。 ', ' 結核性胸膜炎において、胸水中の ADA活性上昇が認められる。 ', '寄生虫 (蠕虫) 感染では好酸球増加と IgE上昇が起こる。 ', ' HIV感染症で、CD4陽性T細胞数が 200/mm³を下回ると日和見感染症、腫瘍などの AIDS 指標疾患を発症しやすくなる。 ', 'SARS-CoV-2 は気道の上皮細胞に感染し、他の上皮細胞には感染しない。 '],
            ...
            groupContents: [{
                ...
                },
                {
                    ...
                    answerImg: [MHCClass1],
                    answer: 'ユビキチン',
                    commentary: 'ユビキチン-プロテアソーム系で内在性抗原をペプチド断片に変えて、HLA class1分子に会合する。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
                ...
                },
                {
                    ...
                    answerImg: [HIV],
                    answer: 'MHCクラス1',
                    commentary: 'HIVはCD4+T細胞に感染するため、CD8のリガンドであるMHCクラスⅠは直接関係しない。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
                ...
                // },
                {
                    ...
                    answerImg: [Rh],
                    answer: '',
                    commentary: '新生児溶血性疾患。ABO血液型に対する抗体はIgMであるため胎盤を通過しない。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
                ...
                },
                {
                    ...
                    answer: '3と4が誤り',
                    commentary: '妊娠初期のM1マクロファージとM2マクロファージは同程度らしい。胎盤脱落膜にはTregが約2倍存在して免疫寛容に寄与している。母児免疫寛容が破綻すると胎児の抗原が母体の免疫システムに攻撃されるが、胎児の免疫機構は成熟していないため逆は起こらない。脱落膜NK細胞の80％はCD56bright NK細胞であり。パーフォリンなどによる細胞障害というよりはサイトカイン産生を主に行う。',
                },
                {
                    detailInfo: '',
                    questionImg: [],
                ...
                },
                {
                    ...
                    answerImg: [],
                    answer: '2と3が誤り',
                    commentary: '血球成分のなかでは赤血球がダントツで多い（およそ400~500万/μL）',
                },
                {
                    detailInfo: '',
                    questionImg: [],
